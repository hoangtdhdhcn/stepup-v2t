...
def create_config(output_dir, domain_type):
    ...
    # Use the in-house pretrained NeMo VAD model
...
def write_srt(transcript, file):
    ...
    for i, segment in enumerate(transcript, start=1):
        ...
        print(
            f"{i}\n"
            f"{format_timestamp(segment['start_time'], always_include_hours=True)} --> "
            f"{format_timestamp(segment['end_time'], always_include_hours=True)}\n"
...
if __name__ == '__main__':
    ...
    # Load the video file
    video_path = "video/0912338926 - 04_10 - B9.mp4"
    ...
    output_audio = f"audio/{base_name}.mp3"
    ...
    if language in punct_model_langs:
        ...
        labled_words = punct_model.predict(words_list,chunk_size=100)
